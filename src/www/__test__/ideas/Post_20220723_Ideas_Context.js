...
export class Post_20220723_Ideas_Context {
  ...
  async thereShouldBeTheSIdea(expected) {
    // text:  * There should be the "Harvest" idea.
    // code: this.thereShouldBeTheSIdea("Harvest")
  ...
  async drawACardFromTheSIdea(s1) {
    // text:  * Draw a card from the "Harvest" idea.
    // code: this.drawACardFromTheSIdea("Harvest")
  ...
  async givenThereIsTheSIdea(s1) {
    // text:  * Given there is the "Harvest" idea.
    // code: this.givenThereIsTheSIdea("Harvest")
  ...
  async theSIdeaShouldRequireNSCard(s1, n1, s2) {
    // text:  * The "Harvest" idea should require 1 "Fruit Plant" card.
    // code: this.theSIdeaShouldRequireNSCard("Harvest", 1, "Fruit Plant")
