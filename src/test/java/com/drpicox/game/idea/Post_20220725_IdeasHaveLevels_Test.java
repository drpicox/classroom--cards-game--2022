...
public class Post_20220725_IdeasHaveLevels_Test {
    ...
    @Test public void testPost() throws Throwable {
        fixtures.runBeforeTestStarts("2022-07-25_ideas_have_levels", "c99257dc24a102449adfd3db35359789");
        context.beforeTest();
        ...
        // #### | Previous Level | XP Threshold | Next Level | Next Berries |                               // #### | Previous Level | XP Threshold | Next Level | Next Berries |
        // #### |---------------:|-------------:|-----------:|-------------:|                               // #### |---------------:|-------------:|-----------:|-------------:|
        // #### |              1 |            9 |          2 |            3 |                               // #### |              1 |            9 |          2 |            3 |
        ...
        context.endTheCurrentMoon();                                                                        // * End the current moon.
        context.theSIdeaShouldRequireTheSumOfNInSTagCards("Seed Idea", 1, "Seed");                          // * The "Seed Idea" idea should require the sum of 1 in "Seed" tag cards.
        context.theSIdeaShouldRequireTheSumOfNInSTagCards("Seed Idea", 1, "Worker");                        // * The "Seed Idea" idea should require the sum of 1 in "Worker" tag cards.
